//Package main generated by 'freedom new-project air'
package main

import (
	_ "air/adapter/controller" //引入输入适配器 http路由
	_ "air/adapter/repository" //引入输出适配器 repository资源库
	"air/server/conf"
